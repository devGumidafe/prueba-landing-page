      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center text-center text-lg-start">
            <h1 class="display-6 fw-bold text-white mb-3 fs-4 fs-md-3 fs-lg-2">
              Protege tu bienestar digital
            </h1>
            <p class="lead text-white mb-4 fs-6 fs-md-5 hyphens-auto">
            ...
            <div class="d-grid d-lg-block">
              <button type="button" class="btn btn-outline-light btn-lg px-4 custom-btn-cta">
